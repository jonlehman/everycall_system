...
export const SHORT_ABANDON_SECONDS = 10;
...
export function computeCallInvoiceEstimate({ baseAmountCents, eligibleCallCount }, pricing = {}) {
  ...
  const overageAmountCents = overageCallCount * callOverageRateCents;
  return {
    ...
    overageCallCount,
    overageAmountCents,
    totalEstimatedInvoiceCents: normalizedBaseAmount + overageAmountCents
  };
}
