...
Return conversation_plan with your caller_goal, readiness, beat and question_purpose alongside recommended_move and boundaries. It is a concise policy/decision record, not private reasoning. The application tracks discovery usage and validates it. Do not put the plan in verified_facts. The separate Live model receives validated facts and app-rendered guidance. Only protected questions require exact speech; optional discovery can be rephrased or deferred for a natural reflection.`;
