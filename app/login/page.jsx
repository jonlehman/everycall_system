  ...
  return (
    <div className="min-h-screen bg-[#f8f9ff] text-[#121c2a] selection:bg-[#dbe1ff] selection:text-[#00174b]">
      <main className="flex min-h-screen flex-col items-center justify-center px-6 py-8">
        <div className="relative -translate-y-[1.375in] w-full max-w-[408px] py-12">
          ...
          <div className="relative z-20 overflow-hidden rounded-xl bg-white px-8 py-10 shadow-[0_40px_80px_-15px_rgba(18,28,42,0.04)]">
            ...
            <form className="space-y-6" onSubmit={submitClientLogin}>
              <div className="space-y-2">
                ...
                <div className="rounded-lg bg-white ring-1 ring-[#c3c6d7]/40 transition-all focus-within:ring-2 focus-within:ring-[#004ac6]/20">
                  <input
                    id="email"
                    name="email"
                    type="email"
                    ...
                    className="w-full border-0 bg-transparent px-4 py-3 text-[#121c2a] placeholder:text-[#737686]/60 focus:outline-none focus:ring-0"
                  />
                </div>
              </div>
