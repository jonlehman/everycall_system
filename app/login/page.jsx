...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9ff] text-[#121c2a] selection:bg-[#dbe1ff] selection:text-[#00174b]">
      <header className="fixed top-0 z-10 flex w-full justify-center px-6 py-8">
      ...
      <main className="flex min-h-screen flex-col items-center justify-center px-6 py-24">
        <div className="relative w-full max-w-md py-12">
          ...
          <div className="relative z-20 overflow-hidden rounded-xl bg-white p-10 shadow-[0_40px_80px_-15px_rgba(18,28,42,0.04)]">
            <div className="mb-10 text-center">
              ...
              <p className="text-sm leading-relaxed text-[#434655]">
                Enter your credentials to access the precision dashboard.
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="group relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border-0 bg-white py-3 pl-11 pr-4 text-[#121c2a] ring-1 ring-[#c3c6d7]/40 transition-all placeholder:text-[#737686]/60 focus:outline-none focus:ring-2 focus:ring-[#004ac6]/20"
                  />
                </div>
              </div>
      ...
      <footer className="mt-auto flex w-full flex-col items-center justify-between gap-4 border-t border-slate-200/20 bg-slate-50 px-8 py-8 md:flex-row">
