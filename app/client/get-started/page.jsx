            ...
            <SetupStepCard
              ...
              descriptionContent={forwarding.numberReady ? (
                <>
                  ...
                  <li>Use this number as your primary business number and have it answer all incoming calls. EveryCall can also blind-transfer callers to configured team members when a caller specifically asks for them.</li>
                  </ul>
                </>
              ) : null}
              statusBox={{
