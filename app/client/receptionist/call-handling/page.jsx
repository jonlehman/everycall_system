...
export default function CallHandlingPage() {
  ...
  return (
    <SectionPage
      ...
      status={status}
      statusChip={{ tone: 'ok', label: 'Routing Systems Online' }}
    ...
    >
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[7fr_3fr]">
        ...
        <GuidePanel title="Call Handling Guide" eyebrow="What belongs here?" icon="architecture">
          <p className="mb-0">
            This workspace defines the logical flow of incoming voice traffic. Use it to configure how EveryCall routes callers during different operating states.
          </p>
          ...
          <div className="rounded-2xl border border-[#d6e4ff] bg-[#f5f8ff] p-3">
            <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#004ac6]">Pro Tip</div>
            <div className="mt-2 text-sm italic text-slate-600">Keep greetings under 15 seconds so callers quickly understand what happens next.</div>
          </div>
        </GuidePanel>
      </div>
    </SectionPage>
