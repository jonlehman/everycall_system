...
assert.match(LIVE_SPEECH_INSTRUCTIONS, /warm, capable receptionist for the business named in your greeting/);
assert.match(LIVE_SPEECH_INSTRUCTIONS, /general knowledge about the industry/);
assert.match(LIVE_SPEECH_INSTRUCTIONS, /specific, fact-based questions about the company or its products and services/);
assert.match(LIVE_SPEECH_INSTRUCTIONS, /Luna also handles actions that need company approval or tools/);
assert.match(LIVE_SPEECH_INSTRUCTIONS, /Answer the caller's immediate question before returning to intake/);
