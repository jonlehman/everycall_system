...
const callGatewayEnvSchema = baseSchema.extend({
  ...
  OPENAI_REALTIME_API_SHAPE: z.enum(["auto", "legacy", "realtime2", "realtime_2", "v1", "v2", "current", "nested", "classic"]).optional(),
  OPENAI_REALTIME_INPUT_RATE_PER_1M_USD: z.string().min(1).optional(),
  OPENAI_REALTIME_CACHED_INPUT_RATE_PER_1M_USD: z.string().min(1).optional(),
  OPENAI_REALTIME_AUDIO_INPUT_RATE_PER_1M_USD: z.string().min(1).optional(),
  OPENAI_REALTIME_OUTPUT_RATE_PER_1M_USD: z.string().min(1).optional(),
  OPENAI_REALTIME_AUDIO_OUTPUT_RATE_PER_1M_USD: z.string().min(1).optional(),
  ...
  OPENAI_SAFETY_IDENTIFIER: z.string().min(1).optional(),
